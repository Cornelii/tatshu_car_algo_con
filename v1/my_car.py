...
class ToGoal:
    ...
    def set_brake(self, car_controls, data):
        if abs(data.track_forward_angles[9]) > 70:
            if data.speed > 80:
    ...
    def cornering_strategy(self, data):
        pass

    def opponents_strategy(self, data):
        pass

    def escape_strategy(self, data):
        pass
...
class Utils:
    ...
    def get_obstacle_map(self, data, half_road_limit=7, m=None):
        ...
        forward_detection_range = data.speed / 3.6 * 1.7 + 5
